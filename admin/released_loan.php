...
<div class="az-content-breadcrumb">
        <span>Junk</span>
        <span>Released Loan</span>           
    </div>
    <h2 class="az-content-title">Released Loan</h2>
...
<a href="confirmed_loans.php"  class="btn btn-secondary" onclick="filterLoans('confirm')">Confirmed</a>
 <a href="released_loan.php"  class="btn btn-primary" onclick="filterLoans('released')">Released</a>
...
WHERE loan.admin_id = '$admin_id' AND
    (collector.first_name LIKE '%$search%' OR collector.last_name LIKE '%$search%' OR loan.ref_no LIKE '%$search%') AND  loan.status = 2
ORDER BY loan.date_created DESC
LIMIT $limit OFFSET $offset";
