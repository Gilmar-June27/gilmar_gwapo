...
if (isset($_POST['update_profile'])) {
    ...
    mysqli_query($conn, "UPDATE `users` SET first_name = '$update_first_name', last_name = '$update_last_name', email = '$update_email', number = '$number', address = '$address' WHERE id = '$admin_id'") or die('Query failed');
