...
$query = "SELECT documentation.*, users.first_name, users.last_name, users.address, 
          ...
          WHERE documentation.collector_id = '$collector_id'";
...
<div class="container mt-4">
   ...
   <a href="postcateg.php"  class="btn btn-primary" onclick="filterLoans('pending')">Paid</a>
   <a href="unpaid.php"  class="btn btn-secondary" onclick="filterLoans('Unpaid')">Unpaid</a>
