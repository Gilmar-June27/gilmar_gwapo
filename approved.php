...
$query = "SELECT * FROM pickup_requests WHERE collector_id='$collector_id' AND status='Approved'";
if ($search != '') {
...
<div class="az-content-breadcrumb">
            <span>Junk</span>
            <span>Approved Pickup Requests</span>           
          </div>
          <h2 class="az-content-title">Approved Pickup Requests</h2>
...
<a href="customerlist.php"  class="btn btn-secondary" onclick="filterLoans('pending')">All</a>
 <a href="pending.php"  class="btn btn-secondary" onclick="filterLoans('released')">Pending</a>
   <a href="approved.php"  class="btn btn-primary" onclick="filterLoans('confirm')">Approved</a>
